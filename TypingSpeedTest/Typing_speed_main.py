# This is TypingTestPythonProject
...
if __name__ == "__main__":
    prompt = "Hi, this code is written by Ankit Bohara, a pasonate software engineer"
    print("Type this:- '", prompt, "'")

    # listening to input ENTER
    input("press ENTER when you have done!")
    ...
    print("Total Time Consumed : ", time, "s")
